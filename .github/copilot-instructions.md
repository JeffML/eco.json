...
This repo (`JeffML/eco.json`) was originally a fork of `hayatbiralem/eco.json`, which has since been archived. `JeffML/eco.json` is now the active continuation of the project.

- All data URLs, the npm package, and CI point to `JeffML/eco.json`
- No upstream PRs needed — hayatbiralem's repo is archived
